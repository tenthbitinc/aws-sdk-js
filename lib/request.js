...
AWS.Response = inherit({
  ...
  nextPage: function nextPage(callback) {
    ...
    if (!this.data[config.outputToken]) {
      return callback ? callback(null, null) : null;
    } else {
      params[config.inputToken] = this.data[config.outputToken];
  ...
  hasNextPage: function hasNextPage() {
    ...
    var operation = this.request.operation;
    var config = this.request.service.paginationConfig(operation);
    return config && this.data[config.outputToken] ? true : false;
  }
